...
typedef int direction_t;       /* branching direction indicator type */
...
#define SOLVER_DIR_DOWN	    CPX_BRANCH_DOWN
#define SOLVER_DIR_UP       CPX_BRANCH_UP
#define SOLVER_DIR_DEFAULT  CPX_BRANCH_GLOBAL
...
#if CPLEX >= 20
#undef SUPPORT_IIS
/* TODO: CPXrefineconflict/CPXgetconflict are deprecated,
 * port to CPXrefineconflictext/CPXgetconflictext
 */
