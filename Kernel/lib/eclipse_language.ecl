...
% Version:	$Id: eclipse_language.ecl,v 1.31 2017/09/07 00:14:07 jschimpf Exp $
...
:- reexport copysign / 3 from sepia_kernel.
...
:- reexport engine_clone / 3 from sepia_kernel.
...
:- reexport get_engine_property / 3 from sepia_kernel.
...
:- reexport eval_to_array / 2 from sepia_kernel.
:- reexport eval_to_complete_list / 2 from sepia_kernel.
:- reexport eval_to_list / 2 from sepia_kernel.
...
:- reexport nexttoward / 3 from sepia_kernel.
...
:- reexport random / 2 from sepia_kernel.
...
:- reexport swapref / 3 from sepia_kernel.
...
:- autoload_system(lists, [
	...
	select/3,
	maplist/2->maplist_body/3, checklist/2->checklist_body/3,
	maplist/3->maplist_body/4, print_list/1->print_list_/2]).
