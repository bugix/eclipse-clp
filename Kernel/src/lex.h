 ...
 * SEPIA INCLUDE FILE
 *
 * VERSION	$Id: lex.h,v 1.13 2017/08/19 19:59:22 jschimpf Exp $
 */
...
#define EOF_IS_NO_FULLSTOP	0x4000000/* don't take EOF as fullstop      */
#define NO_STRING_CONCAT	0x8000000/* don't concat string literals    */

#define SYNTAX_FLAGS		28	/* number of flags above	*/
