...
\biptxtrefni{lex_ne/2}{lex_ne/2!gfd}{../bips/lib/gfd/lex_ne-2.html}
...
\begin{description}
\item[\biptxtrefni{min_index(+Collection,?Index)}{min_index/2!gfd}{../bips/lib/gfd/min_index-2.html}]
Index is constrained to the index(es) of the variable(s) with the minimum value in Collection.

\item[\biptxtrefni{min_first_index(+Collection,?Index)}{min_first_index/2!gfd}{../bips/lib/gfd/min_first_index-2.html}]
...
\biptxtrefni{gfd_search:search/6}{search/6!gfd_search}{../bips/lib/gfd_search/search-6.html}. The syntax is similar to the built-in {\tt search/6}, but allows user defined variable selection and value choice methods.

You can also write your own search in {\eclipse}. You can use the generic 
search's \biptxtrefni{gfd_search:delete/5}{delete/5!gfd}{../bips/lib/gfd_search/delete-5.html} 
and \biptxtrefni{gfd_search:indomain/2}{indomain/2!gfd}{../bips/lib/gfd_search/indomain-2.html}
